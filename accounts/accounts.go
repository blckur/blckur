...
func Oauth2Client(db *database.Database, conf *oauth.Oauth2,
		acct *account.Account) (client *oauth.Oauth2Client, err error) {
...
func oauth2Refresh(db *database.Database, acct *account.Account,
